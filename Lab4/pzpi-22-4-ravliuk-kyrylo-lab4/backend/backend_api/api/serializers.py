...
from backend_api.models import (
    ...
    TypeOfContainer, Containers, IoTFillingContainer, WasteHistory,AdminLoggingChanges,DeviceToken
)
...
class CustomerSerializer(ModelSerializer):
    ...
    class Meta:
        model = CustomUser
        fields = ['id', 'password', 'username', 'email', 'role', 'date_joined']
...
class StationOfContainersSerializer(serializers.ModelSerializer):  
    class Meta:
        ...
        fields = ['id','station_of_containers_name', 'latitude_location', 'longitude_location', 'status_station', 'last_reserved']
...
class CollectionSchedulesSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['id','station_of_containers_id', 'collection_date']
...
class NotificationTypesSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['id','type_notification_name']
...
class NotificationsUserSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['id','user_id', 'message', 'notification_type', 'timestamp_get_notification']
...
class TypeOfContainerSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['id','type_name_container', 'volume_container']
...
class ContainersSerializer(serializers.ModelSerializer):
    class Meta:
        model = Containers
        fields = ['id','fill_level', 'status_container_id', 'last_updated', 'type_of_container_id', 'station_id']


class IoTFillingContainerSerializer(serializers.ModelSerializer):
    class Meta:
        model = IoTFillingContainer
        fields = ['id','container_id_filling', 'sensor_value', 'time_of_detect']
